...
function StatCard({ value, label }: StatCardProps) {
  return (
    <div className="bg-bg-neutral-base flex flex-[1_0_0] flex-col min-h-px min-w-px overflow-clip relative rounded-xlarge">
      <div className="flex gap-[var(--padding-5)] items-center overflow-clip px-5 py-6 relative shrink-0 w-full">
        <div className="bg-bg-neutral-level1 rounded-medium shrink-0 size-12" />
...
function NewsCard({ title, content }: NewsCardProps) {
  return (
    <div className="bg-bg-neutral-base flex flex-[1_0_0] flex-col h-[280px] items-start min-h-px min-w-px overflow-clip relative rounded-xlarge">
